...
package io.agora.hack.believe.common;
...
public class CameraSource {
    ...
    private OnVideoReadListener onVideoReadListener;

    private Runnable onVideoRunnable = new Runnable() {
        @Override
        public void run() {
    ...
    public void setOnVideoReadListener(OnVideoReadListener onVideoReadListener) {
        this.onVideoReadListener = onVideoReadListener;
    }
