...
- (UIButton *)disButton {
    if (!_disButton) {
        ...
        if(_pass == 0) {
            [_disButton setTitle:MCLocalizedString(@"不同意") forState:UIControlStateNormal];
        }
        else {
            [_disButton setTitle:MCLocalizedString(@"不同意并退出") forState:UIControlStateNormal];
        }
        ...
        [_disButton setBackgroundColor:[[UIColor alloc] initWithHexString:@"#EFF4FF"]];
...
- (UIButton *)agreeButton {
    if (!_agreeButton) {
        ...
        if(_pass == 0) {
            [_agreeButton setTitle:MCLocalizedString(@"同意") forState:UIControlStateNormal];
        }
        else {
            [_agreeButton setTitle:MCLocalizedString(@"同意并继续") forState:UIControlStateNormal];
        }
        ...
        [_agreeButton setBackgroundColor:[[UIColor alloc] initWithHexString:@"#2753FF"]];
        // gradient
