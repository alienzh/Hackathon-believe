...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.text = MCLocalizedString(@"手机号");
...
- (UILabel *)areaCodeLabel {
    if (!_areaCodeLabel) {
        ...
        _areaCodeLabel.textColor = [[UIColor alloc] initWithHexString:@"#3C4267"];
...
- (UIView *)line {
    if (!_line) {
        ...
        _line.backgroundColor = [[UIColor alloc] initWithHexString:@"#8A8B9B"];
    }
    return _line;
}
